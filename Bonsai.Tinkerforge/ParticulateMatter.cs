...
namespace Bonsai.Tinkerforge
{
    ...
    public class ParticulateMatter : Combinator<IPConnection, ParticulateMatter.ParticularMatterDataFrame>
    {
        /// <summary>
        ...
        /// </param>
        /// <returns>the 
        /// A sequence of <see cref="ParticularMatterDataFrame"/> objects representing the
        /// measurements from the Particulate Matter Bricklet.
        /// </returns>
        public override IObservable<ParticularMatterDataFrame> Process(IObservable<IPConnection> source)
        {
            return source.SelectStream(connection =>
            {
                ...
                return Observable.Create<ParticularMatterDataFrame>(observer =>
                {
                    BrickletParticulateMatter.PMConcentrationEventHandler handler = (sender, pm10, pm25, pm100) =>
                    {
                        observer.OnNext(new ParticularMatterDataFrame(pm10, pm25, pm100));
                    };
        ...
        public struct ParticularMatterDataFrame
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="ParticularMatterDataFrame"/> structure.
            /// </summary>
            ...
            public ParticularMatterDataFrame(int pm10, int pm25, int pm100)
            {
                Pm10 = pm10;
                Pm25 = pm25;
                Pm100 = pm100;
